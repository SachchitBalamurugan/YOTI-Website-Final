      ...
      <Wrapper>
        ...
        <Content>
          ...
          <p style={{marginTop: "60px"}}>
            ...
            Thank you for your interest in YOTI (Youth Opportunities in Tech Innovation)! At YOTI, we are passionate about bridging the digital divide by empowering young individuals through computer science education. Our mission is to equip the next generation with the skills and confidence they need to excel in the technology sector and become leaders of innovation.

If you have any questions about our programs, want to partner with us, or simply want to learn more about our mission, please don't hesitate to reach out. We welcome your inquiries and look forward to connecting with you.
<br/><br/>
          ...
          <div className="container">
            <div className="row align-items-center justify-content-between">
              <div className="col-12 col-lg-5">
                ...
                >
                  <h2 style={{ fontWeight: "300", color: "#61999c" }}> <br/>Get In Touch</h2>
                </div>
                  ...
                  <form action="https://api.web3forms.com/submit" method="POST">
                    <div className="row">
                      <input
                        type="hidden"
                        name="access_key"
                        value="891140de-9654-4c87-bc10-115ecb85a499"
                      />
                      <div
